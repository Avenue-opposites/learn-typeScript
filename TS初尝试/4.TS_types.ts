...
let obj1:{name:string,age:number,gender?:boolean};
// obj1 = {};//类型 "{}" 中缺少属性 "name"
...
let strArr1:string[];//字符串数组
let strArr2:Array<string>;//字符串数组
let numArr1:number[];//数字数组
let numArr2:Array<number>;//数字数组
strArr1 = ["one","two"];
strArr2 = ["three","four"];
numArr1 = [1,2,3];
numArr2 = [4,5,6];
